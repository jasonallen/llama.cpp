...
This supports the [[moondream]](https://moondream.ai) model.

## Usage
Build with cmake or run `make md-cli` to build it.

After building, run: `./md-cli` to see the usage. For example:
...
- Download latest moondream models ([available options](https://github.com/haotian-liu/LLaVA/blob/main/docs/MODEL_ZOO.md)). For example:
