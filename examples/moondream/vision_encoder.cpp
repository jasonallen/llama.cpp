...
static ggml_cgraph *clip_image_build_graph(clip_ctx *ctx, const clip_image_f32_batch *imgs)
{
    ...
    GGML_UNUSED(num_patches_per_side);
    ...
    for (int il = 0; il < n_layer; il++)
    {
        ...
        //  if (il == 0) {
        //      cur = ggml_norm(ctx0, ggml_inspect(ctx0, cur, "layer"), eps);
    ...
    // llava projector
    {
        ...
        GGML_ASSERT(ctx->proj_type == PROJECTOR_TYPE_MLP);
...
bool clip_image_preprocess(struct clip_ctx *ctx, const clip_image_u8 *img, clip_image_f32_batch &res_imgs)
{
    ...
    {
        // MOONDREAM-TODO: consider yanking this as moondream possibly doesn't pad to square image.
    ...
    {
        // MOONDREAM-TODO: yank this shit as it's llava-1.6 spatial crap we don't use
